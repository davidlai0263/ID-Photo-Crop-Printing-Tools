...
class PhotoCropper:
    def __init__(self, root):
        ...
        # 建立打開圖片的按鈕
        self.open_button = tk.Button(self.root, text="打開圖片", command=self.open_image)
        self.open_button.pack()

        # 建立裁切圖片的按鈕
        self.crop_button = tk.Button(self.root, text="裁切圖片", command=self.crop_image)
        self.crop_button.pack()

        # 1寸照片
        self.one_inch_button = tk.Button(self.root, text="1寸照片", command=self.one_inch)
        self.one_inch_button.pack()

        # 2寸照片
        self.two_inch_button = tk.Button(self.root, text="2寸照片", command=self.two_inch)
        self.two_inch_button.pack()

        # Debug
        self.debug_button = tk.Button(self.root, text="Debug", command=self.debug)
    ...
    def crop_image(self):
        ...
        # 裁切圖片
        cropped_image = self.original_image.crop((box_x, box_y, box_x2, box_y2))
